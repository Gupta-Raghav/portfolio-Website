...
export default function About() {
  ...
  const encodedURL = encodeURIComponent("https://tracker.gg/valorant/profile/riot/Rg2#6078/overview");
  return (
            ...
            <Grid item md={6} style={{
              ...
              Know Who <strong className="purple">I'M</strong></h1>
                ...
                In addition to my programming skills, I am also interested in <strong className='purple'>UI/UX design</strong> and am always looking for ways
                  ...
                  trying out different cuisines, <strong className='purple'>capturing cadid moment</strong>, and playing competitive <a href={encodedURL} target="_blank"><strong className='purple'>FPS-shooter games</strong></a> . 
                  <br/>
                  <br/>
